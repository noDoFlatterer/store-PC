<template>
  <div>
    <div>
      <a-button @click="goBack()" type="primary" class="add">返回上一级</a-button>
      <a-button @click="showInput()" type="primary" class="add">增加商品</a-button>
      <a-button
        danger
        type="primary"
    ...
    >
      <template #bodyCell="{ column, record }">
        <template v-if="column.dataIndex === 'done'">
          <a-radio-group>
            <a-radio-button @click="change(record)" value="small">修改</a-radio-button>
            <a-radio-button @click="next(record)" value="small">下级分类</a-radio-button>
            <a-radio-button @click="deleteOne(record)" value="small">删除</a-radio-button>
          </a-radio-group>
        </template>
      </template>
    </a-table>
